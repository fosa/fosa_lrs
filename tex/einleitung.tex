...
\section{Systeme}
\includegraphics[width = \linewidth]{../fig/systeme.eps}
\\\\
Signale sind rückwirkungsfrei, also eingeprägte Grössen.
\\\\
\begin{center}
	\includegraphics[scale = 0.5]{../fig/system_bsp.eps}
\end{center}
\newpage
...
\begin{center}
	\includegraphics[scale = 0.8]{../fig/linearisierung.eps}
\end{center}
...
\begin{center}
	\includegraphics[scale=0.7]{../fig/nyquist.eps}
\end{center}
...
\begin{center}
	\includegraphics[scale=0.9]{../fig/bode_reserve.eps}
\end{center}
...
\begin{center}
\includegraphics[scale = 1]{../fig/komp_grnd.eps}
\end{center}
...
\hline \rule[-2ex]{0pt}{5.5ex} $\e^{-sT}$ & \includegraphics[scale = 0.3]{../fig/bode_est.eps} & \includegraphics[scale = 0.4]{../fig/ort_est.eps} & \includegraphics[scale = 0.5]{../fig/spr_est.eps} \\ 
\end{tabular} 
